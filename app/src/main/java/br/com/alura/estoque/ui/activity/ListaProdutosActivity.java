...
public class ListaProdutosActivity extends AppCompatActivity {
    ...
    private static final String MSG_ERRO_BUSCAR = "Não foi possível carregar os produtos da nuvem";
    private static final String MSG_ERRO_REMOVER = "Não foi possível remover o produto";
    private static final String MSG_ERRO_SALVAR = "Não foi possível salvar o produto";
    private static final String MSG_ERRO_EDITAR = "Não foi possível editar o produto";
